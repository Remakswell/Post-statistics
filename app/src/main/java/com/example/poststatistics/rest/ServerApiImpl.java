...
public class ServerApiImpl implements ServerApi {
    ...
    public void addLikedUsersList() {
        ...
        retrofitRestService.getLikedUsersList(APPLICATION_JSON, APPLICATION_JSON, "Bearer " + TOKEN, new PostRequest(2720L))
    ...
    public void addViewsCount() {
        ...
        retrofitRestService.getPost(APPLICATION_JSON, APPLICATION_JSON, "Bearer " + TOKEN, new PostRequest(2720L))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
